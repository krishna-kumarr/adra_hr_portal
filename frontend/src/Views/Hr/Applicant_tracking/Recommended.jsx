                            ...
                            <div className="col-12 recuirement-card-notification py-3 mb-2 border-bottom">
                                <div className="row">
                                    <div className="col-10 row">
                                        ...
                                        <p className="mb-0">seen your recommendation and shortlisted the candidate</p>
                                        <div className="col-8">
                ...
                <div className="col-12 col-xxl-7 ps-xxl-2 applicant-page-table-height">
                    <div className='card border-0 rounded-4 h-100'>
                        <div className="container-fluid h-100 applicant-table-Overflow">
                            <DataTable title="Recommended" className="dataTables_wrapper" columns={columns} data={registeredApplicants} progressPending={pending} pagination />
                        </div>
                    </div>
                </div>
            </div>
